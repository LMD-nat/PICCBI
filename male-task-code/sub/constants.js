...
for (i in x) {
if (x[i] >= 100) {
   images.push('stim/T'+x[i]+'.png')//thin
  } else {
   images.push('stim/T0'+x[i]+'.png')
  }
};
images.push('stim/N000.png') ;// neutral

for (i in _.range(10, 310, 10)) {
  if (_.range(10, 310, 10)[i] < 100) {
   images.push('stim/H0'+_.range(10, 310, 10)[i]+'.png')//fat
  } else {
   images.push('stim/H'+_.range(10, 310, 10)[i]+'.png')
  }
};
...
function stimRandomizer(block,freq,numtrials) {
  ...
  for (i in _.range(10, 310, 10)) {
    if (_.range(10, 310, 10)[i] < 100) {
      thin.push('stim/T0'+_.range(10, 310, 10)[i]+'.png')
      fat.push('stim/H0'+_.range(10, 310, 10)[i]+'.png')
    } else {
      thin.push('stim/T'+_.range(10, 310, 10)[i]+'.png')
      fat.push('stim/H'+_.range(10, 310, 10)[i]+'.png')
    }
  };
  signals = []; // fat
  noise = []; // thin
